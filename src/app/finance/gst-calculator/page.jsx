    ...
    <>
      ...
      <div className="text-gray-700 mt-10">
        ...
        <ol className="list-decimal ml-6 mb-8">
          <li className="mb-2">
            <strong>Easy GST Calculation:</strong> - CalcPlus&apos;s GST Calculator simplifies the process of
            calculating Goods and Services Tax. Enter the base amount and GST rate, and the calculator swiftly computes
            the total amount including GST.
          </li>
          <li className="mb-2">
            <strong>User-Friendly Interface:</strong> - The GST Calculator boasts an intuitive interface for seamless
            interaction. Input your details, and receive the total amount including GST promptly.
          </li>
          <li className="mb-2">
            <strong>Immediate Results:</strong> - Experience instant feedback with real-time GST calculation. Upon
            entering details, the calculator promptly displays the total amount including GST.
          </li>
          <li className="mb-2">
          ...
          <li className="mb-2">
            <strong>Mobile-Friendly Design:</strong> - Access the GST Calculator effortlessly across various devices.
            Whether on a smartphone, tablet, or desktop, CalcPlus ensures a seamless and responsive user experience.
          </li>
          <li className="mb-2">
            <strong>Time-Saving and Convenient: </strong> - Save time with CalcPlus&apos;s GST Calculator, eliminating
            the need for manual calculations. Obtain precise total amounts including GST within seconds, allowing you to
            manage your finances effectively.
          </li>
        </ol>
        <p className="text-sm mt-4">
          <strong>Disclaimer:</strong> Please note that CalcPlus&apos;s GST Calculator serves informational purposes
          only and should not replace professional financial advice. Users are encouraged to verify the accuracy of GST
